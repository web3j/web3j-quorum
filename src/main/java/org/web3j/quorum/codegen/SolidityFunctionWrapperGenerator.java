 ...
 *
 * This is a modified version of the version provided with web3j. Depending on how Quorum evolves
 * will dictate if this goes back into the main web3j project.
 */
public class SolidityFunctionWrapperGenerator {
    ...
    protected static final String CONTRACT_ADDRESS = "contractAddress";
    protected static final String GAS_PRICE = "gasPrice";
    protected static final String GAS_LIMIT = "gasLimit";

    protected static final String CODEGEN_WARNING = "<p>Auto generated code.<br>\n" +
            "<strong>Do not modify!</strong><br>\n" +
            "Please use {@link " + org.web3j.codegen.SolidityFunctionWrapperGenerator.class.getName() +
            "} to update.</p>\n";

    protected static final String USAGE = "solidity generate " +
    ...
    protected static String parsePositionalArg(String[] args, int idx) {
    ...
    protected static String parseParameterArgument(String[] args, String... parameters) {
    ...
    protected static void exitError(String message) {
