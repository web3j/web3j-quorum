...
public class RaftPeer {
    ...
    public RaftPeer(String ip, String nodeId, String p2pPort, String raftId, String raftPort) {
        this.setIp(ip);
    ...
    public boolean equals(Object o) {
        ...
        if (getP2pPort() != null
                ? !getP2pPort().equals(that.getP2pPort())
                : that.getP2pPort() != null) {
            return false;
        }

        if (getRaftId() != null
                ? !getRaftId().equals(that.getRaftId())
                : that.getRaftId() != null) {
            return false;
        }

        return getRaftPort() != null
                ? !getRaftPort().equals(that.getRaftPort())
                : that.getRaftPort() != null;
    }
