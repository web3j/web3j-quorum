...
//			Snapshot snap2 = cakeshop.istanbulGetSnapshotAtHash(blockHash).send().getSnapshot().get();
...
//			List<String> validators2 = cakeshop.istanbulGetValidatorsAtHash(blockHash).send().getValidators();
//			System.out.println("validators2 " + validators2);
			...
			if(validators != null && !validators.isEmpty()) {
				...
				String propose = quorum.istanbulPropose(candidateAddress, true).send().getNoResponse();
